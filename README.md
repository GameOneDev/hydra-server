...
versions on its next sync; the *Delete retained older versions* task under
*Schedule* clears the rest, for games nobody syncs any more. Uploads that never finished
